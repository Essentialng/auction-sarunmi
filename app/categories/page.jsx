...
//         const {fetchAllProduct, others, products} = useStore()
...
export default function Page(){
    ...
    return(
        <div className="flex flex-col relative pt-[10rem] ">
           ...
           <SleiderProduct data={cars} header="Top Auctions"/>
            <div className="2xl:grid xl:grid block grid-cols-4 pt-24 2xl:px-[4rem] xl:px-[4rem] px-[1rem]">
                ...
                <div className="col-span-3 ">
                    <Products page="categories" headline="" detail="" category={categories} style="" data={others}/>
                </div>
            </div>
