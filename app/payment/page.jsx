          ...
          <div className="col-span-3 bg-white p-8 rounded-lg shadow-lg  w-full">
            ...
            <div className="flex justify-center mb-12">
              ...
              className={classNames(
                {"ring-orange-500 border-orange-500 bg-orange-100 border ": togglePayment == "card"},
              "flex items-center justify-center rounded-lg py-2 px-4 mx-2 focus:ring-2 "
            )}
              onClick={()=>{
              ...
              <button 
              className={classNames(
                {"ring-orange-500 border-orange-500 bg-orange-100 border ": togglePayment == "payPal"},
              "flex items-center justify-center rounded-lg py-2 px-4 mx-2 focus:ring-2")}
              onClick={()=>{
              ...
              <button 
              className={classNames(
                {"ring-orange-500 border-orange-500 bg-orange-100 border ": togglePayment == "transfer"},
              "flex items-center justify-center rounded-lg py-2 px-4 mx-2 focus:ring-2"
            )}
              onClick={()=>{
            ...
            {togglePayment == "card" ? 
              <form className="space-y-4">
                ...
                <div className="w-full flex items-center justify-center">
                  <button type="submit" className="w-2/3 py-3 bg-orange-500 text-white font-semibold rounded-lg hover:bg-orange-600">
                    SUBMIT PAYMENT
                  </button>
                </div>
              </form>
